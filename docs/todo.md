...
Nothing is open. Every review finding raised so far has shipped, and so has the one feature that
had been promoted here — see [done.md](done.md). [feature-ideas.md](feature-ideas.md) still holds
